...
use danneo_sdk::{
    apanel::render_admin_template, auth::Claims, models::core_admin_groups, state::AppState,
};
...
pub async fn list_groups(_claims: Claims, State(state): State<Arc<AppState>>) -> impl IntoResponse {
    ...
    render_admin_template(state, "apanel/agroups_list.html", context).await
}
...
pub async fn edit_group(
    ...
    render_admin_template(state, "apanel/agroups_edit.html", context).await
}
